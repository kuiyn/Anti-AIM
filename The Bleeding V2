...
local LAST_VERSION = http.Get("https://raw.githubusercontent.com/MN1R/TheBleeding/main/AntiAimVersion")
...
if LAST_VERSION ~= CURRENT_VERSION then
    ...
    --getting latest data
    local LAST_LUA_DATA = http.Get("https://raw.githubusercontent.com/MN1R/TheBleeding/main/AntiAimsCode")
